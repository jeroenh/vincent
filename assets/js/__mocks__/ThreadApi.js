...
const mock = jest.fn().mockImplementation(() => {
	...
	getCaseStates: () => {
	    return Promise.resolve(data["case_states"]);
	},
	getUser: () => {
	    return Promise.resolve(
		{
			...
			name: 'Vullabs',
			type: 'Group',
			url: '/cvdp/groups/773d5eb0-fe79-4cb3-9573-929e10e25b12/',
			photo: null,
			logocolor: '#9c2c97',
			uuid: "773d5eb0-fe79-4cb3-9573-929e10e25b12"}],
		    logocolor:"#7FF3AE",
		    name:"emily",
		    org:"",
		    photo:"",
	...
	getMyActivity: () => {
	    return Promise.resolve(mockactivityresults);
	},
	getCasesByPage: () => {
	    return Promise.resolve(mockcaseresults);
	},
	...
	/* first time this is called, it returns empty, second time results */
	searchThreads: jest.fn().mockImplementationOnce(()=> {return Promise.resolve([])}).mockReturnValue(Promise.resolve(data['post_search'])),
