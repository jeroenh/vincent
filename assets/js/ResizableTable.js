...
const ResizableTable = ({columns, data, setSelectedRows, update, showRowExpansion, hasMore, searchParams, selectedRows, skipPageResetRef, sort, onHeaderClick}) => {
	...
	<Styles>
		...
		<div className="d-flex">
			...
			<label>
                            <input type="checkbox" role="checkbox" {...getToggleHideAllColumnsProps()} />{" "}
			...
			<div className="cb action" key={column.id}>
			    <label>
			    <input type="checkbox" name={column.id} role="checkbox" {...column.getToggleHiddenProps()} />{" "}
	    ...
	    >
		<BTable className="table" aria-label="Component Table" id="componentTable" hover {...getTableProps()}>
		    <thead>
