...
export default class ContactAPI{
    ...
    getGroupsByTag(tag) {
	let url = `${API_URL}/api/groups/?type=tag&name=${tag}`;
        return axios.get(url).then(response => response.data);
    }
    ...
    getAllUnverified() {
	const url = `${API_URL}/api/groups/unverified/`;
        return axios.get(url).then(response => response.data);
    }

    getMoreUnverified(url) {
        return axios.get(url).then(response=>response.data);
    }
    ...
    getGroupCasePerms(group) {
	const url = `${API_URL}/api/manage/group/${group}/perms/`;
	return axios.get(url).then(response=> response.data);
    }

    setGroupCasePerms(group, data) {
        const url = `${API_URL}/api/manage/group/${group}/perms/`;
        return axios.patch(url, data).then(response=> response.data);
    }
	...
	const url = `${API_URL}/api/contacts/${contact}/`;
        return axios.delete(url).then(response => response.data);
    }
    ...
    getContactDetail(c) {
	const url = `${API_URL}/contact/${c}/detail/`;
        return axios.get(url).then(response => response.data);
    }
    ...
    getCoordTeams() {
	let url = `${API_URL}/api/groups/coordinators/`;
	return axios.get(url).then(response => response.data);
    ...
    removeCoordTeam(id) {
        let url = `${API_URL}/api/groups/coordinators/${id}/`;
        return axios.delete(url).then(response => response.data);
    }	
