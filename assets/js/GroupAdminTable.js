...
const GroupAdminTable = ({columns, data, setSelectedRows, fetchData, group, api, loading, update, hidden=[]}) => {
    ...
    return (
        <BTable aria-label="Group Contacts and Users" className="table" hover {...getTableProps()}>
            <thead>
