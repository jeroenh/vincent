	...
	<Card className="mt-3 mb-3">
		...
		{props.user.role === "owner" &&
		 <DropdownButton variant="btn p-0"
				 title={<i className="bx bx-dots-vertical-rounded" title="Manage Case Participants"></i>}
		 >
		...
		{showRemove &&
		 <div className="d-grid mb-2">
		     <Button variant="warning" onClick={(e)=>setShowRemove(false)} size="sm">Cancel Remove</Button>
		 </div>
		}
			 ...
			 return (
				 ...
				 <div className="d-flex align-items-center gap-2 mt-2 mb-2">
					 ...
					 <a href="#" onClick={(e)=>e.preventDefault()}>
					     ...
					     {props.user.role === "owner" && (
						 <>
						     {post.participant.notified ? "" :
						      <i className="fas fa-phone-slash mx-2"></i>
						     }
						 </>
					     )
					     }
				 ...
				 {showRemove && post.participant.role !== "owner" &&
				  <Button variant="btn pe-3"
