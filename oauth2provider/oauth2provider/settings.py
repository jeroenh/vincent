...
#set to True to enable email verification.  This is done in VINCE-NT so we don't
# need to do it twice.
ACCOUNT_EMAIL_VERIFICATION = False
LOGIN_REDIRECT_URL = 'provider:welcome'

DASHBOARD_LINK = os.environ.get('DASHBOARD_LINK', 'http://localhost:8000/cvdp/dashboard/')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'vincentprovider'),
        'USER': db_user,
...
#       a redeployment of the VINCE-NT application container as well, presuming
