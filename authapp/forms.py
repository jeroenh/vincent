...
class ProfileForm(forms.Form):
    ...
    org = forms.CharField(
        ...
        error_messages={'invalid':_("Oops! Invalid value. This field may not contain certain special characters.")},
        required=False)
    ...
    title = forms.CharField(
        ...
        validators=[RegexValidator('[+-/%]', inverse_match=True)],
        error_messages={'invalid':_("Oop! Invalid value. This field may not contain certain special characters.")},
        required=False)
...
class PreferencesForm(forms.Form):
    ...
    email_new_tickets = forms.BooleanField(
        label=_('New tickets and ticket changes'),
        help_text=_('We will let you know tickets have been assigned to you or of important ticket changes.'),
        required=False,
    )
