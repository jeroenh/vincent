        ...
        with open(options['in'][0], 'r') as f:
            ...
            for t in tmpls:
                ...
                if tmpl:
                    ...
                    created = created + 1
                    new_template = EmailTemplate.objects.create(template_name=t['fields']['template_name'],
                                                                locale=t['fields']['locale'],
                                                                subject=t['fields']['subject'],
                                                                title=t['fields']['title'],
                                                                html=t['fields']['html'],
                                                                plain_text = t['fields']['plain_text'],
                                                                template_type=t['fields']['template_type'])
                    

            logger.info(f"Updated {num_templates} templates, created {created} templates")
