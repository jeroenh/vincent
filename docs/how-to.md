...
A VINCE-NT Case is the core object for tracking vulnerabilities.  A Case
...
"Assignment roles" in the VINCE-NT admin panel.  Once roles have been added, staff members
...
staff members or superusers in the VINCE-NT admin panel.  Any coordinator within the system
...
#### Reporter
   ...
   user on your VINCE-NT system, they will automatically be added to the case and will be notified
...
A VINCE-NT Report is information about a vulnerability that is provided in a
a structured format.  With VINCE-NT, you can customize the format of your vulnerability
reporting form through the Form Manager in your VINCE-NT settings. VINCE-NT allows you
...
A VINCE-NT Vulnerability is the object that maintains information about
...
A VINCE-NT Case Thread is essentially the message board to contain
...
each new VINCE-NT case. A Case Thread is comprised of a series of Posts made by
Case Participants.  
...
A VINCE-NT Case Participant is a [Contact](#contact) or [Group](#Group) that is invited to participate
in the CVD process.  Each Case Participant has been assigned 1 of 5 [Case Roles](#case-roles).

### Thread Participant

A VINCE-NT Thread Participant is a subset of the Case Participant List for each Case.
...
A VINCE-NT User is an individual that has signed up for an VINCE-NT account and has
a valid, verified email address. When signing up for an VINCE-NT account, a user
...
A VINCE-NT Contact is a [User](#User) or a potential User (an email address). When a User
...
A VINCE-NT Group has a unique name and can contain 0 or more VINCE-NT Contacts. Once a Group
...
A VINCE-NT Message is essentially a private message thread outside a Case. Non-coordinators
...
message any VINCE-NT user or Group by searching for their screen name, name, or email address.


### Component

A VINCE-NT component is a named application, container, device, library, file, framework, Operating
...
A component can contain 0 or more dependencies which are themselves components within VINCE-NT.
...
Eventually, VINCE-NT will allow you to upload a SBOM in order to populate your components.  Each
[Group](#Group) within VINCE-NT can manage their own components.  VINCE-NT coordinators can
view all components defined within the system.


### Advisory

A VINCE-NT Advisory is a document that can be generated that describes the vulnerability.
...
with Case Participants. Eventually, VINCE-NT will allow different methods of sharing the
Advisory.
