# VINCE-NT Reporting Form

This page will assist a staff level user in creating an VINCE-NT
reporting form.  The reporting form will be accessible to authenticated
and non-authenticated (anonymous) users. VINCE-NT allows a coordination
team to customize the vulnerability reporting form though the Form Manager
in the VINCE-NT settings.  The application allows
...
1. A running VINCE-NT system. Follow the [README-quickstart](./README-quickstart).
2. A staff-level user account. (Create an VINCE-NT user and
have the admin (superuser) check the "Staff" option in the VINCE-NT admin dashboard.)
